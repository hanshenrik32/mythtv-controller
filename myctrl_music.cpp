...
musicoversigt_class::~musicoversigt_class() {
...
void musicoversigt_class::show_music_oversigt(GLuint normal_icon,GLuint back_icon,GLuint dirplaylist_icon,int music_key_selected) {
  int buttonsize=180;
  int buttonsizey=180;
  int i=0;
  int ii=0;
