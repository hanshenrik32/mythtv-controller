...
# -Wall
CFLAGS = -Wno-format-truncation -pthread -m64  -ggdb -std=c++17 -Wno-format-overflow Wformat-truncation -Wformat-truncation=2 
LDFLAGS= 
...
ifeq ($(shell uname),Darwin)
	...
	LIBS = -lX11 -lglut -lGLU -lm -lIL -lSDL `sdl-config --libs` -lSDL_image -lpthread -lxml2 -lcurl -lfreetype -ljsoncpp
endif
