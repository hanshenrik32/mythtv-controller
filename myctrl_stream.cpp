...
*/
      ...
      if (check_rss_feed_exist(conn,"Manden, der blev stjålet")==0) {
      ...
      //  Barometeret
      if (check_rss_feed_exist(conn,"Barometeret")==0) {
      ...
      //  Et langsomt mord
      if (check_rss_feed_exist(conn,"Et langsomt mord")==0) {
...
*/
      ...
      // Swingercast
      if (check_rss_feed_exist(conn,"Swingercast")==0) {
