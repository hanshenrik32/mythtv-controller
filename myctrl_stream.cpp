...
int stream_class::opdatere_stream_oversigt(char *art,char *fpath) {
    ...
    if (conn) {
      ...
      if (!(dbexist)) {
        ...
        sprintf(sqlselect,"INSERT INTO mythconverg.internetcontentarticles VALUES ('DEN GRÅ SIDE',NULL,NULL,'DEN GRÅ SIDE',0,0,NULL,'http://feeds.feedburner.com/PersonalityHackerPodcast',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)");
        mysql_query(conn,sqlselect);
        res = mysql_store_result(conn);
        mysql_free_result(res);
        mysql_close(conn);
