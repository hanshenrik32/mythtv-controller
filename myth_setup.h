...
struct tv_graber_config {
  ...
  const char *graberland[35]={"None","North America","Holland","Spain","Israel","North America","Latin America (not working)","Osa 9/10","Europe tv","Sweden","Portugal","France","United Kingdom","Hungary/Romania","Switzerland","Italy","Iceland","Finland","North America","Tyrkiye","German speaking area","Danmark","Sweden","Argentina","France","UK"};
