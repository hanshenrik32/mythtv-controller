...
struct tv_graber_config {
  int graberantal=24;
  int graberaktivnr=0;
  const char *graberland[35]={"North America","Holland","Spain","Israel","North America","Latin America","Osa 9/10","Europe tv","Sweden","Portugal","France","United Kingdom","Hungary/Romania","Switzerland","Italy","Iceland","Finland","North America","Tyrkiye","German speaking area","Danmark","Sweden","Argentina","France","UK"};
