...
class tv_oversigt_prgtype {					// char type fra mythtv ver 0.22/24
    public:
        ...
        tv_oversigt_prgtype();
        ~tv_oversigt_prgtype();
        int putprograminfo(char *prgname,char *stime,char *etime,char *prglength,char *sunixtime,char *desc,char *subtitle,int ptype,int prgrecorded);	// push program info
        void getprograminfo(char *prgname,char *stime,char *etime,int *prglength,unsigned long *sunixtime,char *desc,char *subtitle,int *ptype,bool *bgt,int *prgrecorded);
...
class tv_oversigt {
    ...
    public:
        ...
        void build_tv_oversigt(int xxofset,int kanalstartofset);
        void show_tv_oversigt1(int startxofset); 
        void build_fasttv_oversigt(int selectchanel,int selectprg);
        void show_fasttv_oversigt(int selectchanel,int selectprg); 
        void show_fasttv_oversigt1(int selectchanel,int selectprg); 		// denne som bruges
