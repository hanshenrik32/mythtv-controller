...
int FMOD_Main()
{
    ...
    FMOD_RESULT result = lowLevelSystem->setOutput(FMOD_OUTPUTTYPE_ATMOS);	// NOTE - NEEDS ATMOS DLL, WRITE TO SUPPORT@FMOD.COM
    if (result != FMOD_OK)
    {
        result = lowLevelSystem->setOutput(FMOD_OUTPUTTYPE_AUDIO3D);
    }
